// UC 12: Ability to create Employee Payroll Data with id, name and salary
{
    ...
    empPayroll.id = 2;
    empPayroll.name = "Mohsin";
    empPayroll.salary = 40000;
    console.log(empPayroll.toString());
}
...

{
    ...
    empPayroll.name = "Mohsin";
    console.log(empPayroll.toString());
    let newEmployeePayroll = new EmployeePayroll(1, "Akeel", 40000, "M", new Date());
...
*/
{
    ...
    try {
        ...
        empPayroll.salary = 40000;
        empPayroll.gender = 'M';
        empPayroll.startDate = '04-12-2021';//MM-DD-YYYY
        console.log(empPayroll.toString());
    }
    catch (e) {
        console.error(e);
    ...
    let newEmployeePayroll = new EmployeePayroll(1, "Akeel", 50000, "M", new Date());
    console.log(newEmployeePayroll.toString());        
}